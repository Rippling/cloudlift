...
service is down',
    ...
    def _add_service(self, service_name, config):
        ...
        if 'udp_interface' in config:
            ...
            if launch_type == self.LAUNCH_TYPE_FARGATE or 'udp_interface' in config:
    ...
    def _add_alb(self, cd, service_name, config, launch_type):
        ...
        target_group_config = {}
        if launch_type == self.LAUNCH_TYPE_FARGATE or protocol=='udp':
        ...
        if protocol == 'http':
            ...
            target_group_config['Port'] = int(elb_config['health_check_port'])
            target_group_config['TargetType'] = 'ip'
